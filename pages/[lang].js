...
export default function Home(props) {
  ...
  return (
    <>
      ...
      {/* Web Dev Promo */}
      {!(props.lang === 'jp') && <section className="promo bg-primary flex flex-col items-center p-5">
        <p className="  text-center">
          {props.lang === 'en' && "Looking to create a website? I can create it for you!"}
          {props.lang === 'id' && "Ingin membuat website? Saya bisa bantu!"}
        </p>
        <a className="" href="/webdev">
          <div className="px-3 py-2 mt-2 rounded-md bg-gray-800 hover:bg-gray-600 w-max text-white text-center">
            {props.lang === 'en' && "Learn more"}
            {props.lang === 'id' && "Pelajari lebih lanjut"}
          </div>
        </a>
      </section>}
