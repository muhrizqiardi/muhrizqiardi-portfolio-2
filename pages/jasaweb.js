    ...
    <>
      ...
      <header id="header" className={`px-5 md:px-20 `}>
        ...
        <section id="hero" className="py-10 flex flex-col items-center justify-center">
          ...
          <p>(bisa nego)</p>
          <div className="rounded-md bg-yellow-500 cursor-pointer hover:scale-105 font-bold px-3 py-2 mt-7">
            Hubungi Saya
          </div>
        </section>
      ...
      {/* Chat Bubble */}
      <button onClick={event => setChatDialogState(x => !x)} className=" rounded-full bg-green-600 hover:bg-green-700 shadow-md fixed bottom-0 right-0 cursor-pointer m-5 select-none p-4 w-max font-bold text-white">
        {/* Chat */}
        {
          chatDialogState ?
